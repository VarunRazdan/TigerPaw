...
ENT_TMP_BASE=$(mktemp -t tigerpaw-entitlements-base.XXXXXX)
ENT_TMP_APP_BASE=$(mktemp -t tigerpaw-entitlements-app-base.XXXXXX)
ENT_TMP_RUNTIME=$(mktemp -t tigerpaw-entitlements-runtime.XXXXXX)
