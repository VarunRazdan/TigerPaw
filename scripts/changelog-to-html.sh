...
if [[ -z "$version_content" ]]; then
  echo "<h2>Tigerpaw $VERSION</h2>"
  echo "<p>Latest Tigerpaw update.</p>"
  echo "<p><a href=\"https://github.com/varunrazdan/tigerpaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
