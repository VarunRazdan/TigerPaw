...
export const TRADING_CONNECT_INFO: Record<string, ConnectInfo> = {
  alpaca: {
    ...
    steps: [
      ...
      "Enter your keys below, then click Save to Config",
    ],
    hasSandbox: true,
    sandboxLabel: "paper",
  },
  polymarket: {
    ...
    steps: [
      ...
      "Enter all credentials below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  kalshi: {
    ...
    steps: [
      ...
      "Enter your credentials below, then click Save to Config",
    ],
    hasSandbox: true,
    sandboxLabel: "demo",
  },
  manifold: {
    ...
    steps: [
      ...
      "Generate an API key",
      "Enter your API key below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  coinbase: {
    ...
    steps: [
      ...
      "Enter the key name and PEM below, then click Save to Config",
    ],
    hasSandbox: true,
  ...
  ibkr: {
    ...
    steps: [
      ...
      "Enter your account ID below, then click Save to Config",
    ],
    hasSandbox: true,
    sandboxLabel: "paper",
  },
  binance: {
    ...
    steps: [
      ...
      "Enter both keys below, then click Save to Config",
    ],
    hasSandbox: true,
  ...
  dydx: {
    ...
    steps: [
      ...
      "Enter the mnemonic below, then click Save to Config",
...
export const CHANNEL_CONNECT_INFO: Record<string, ConnectInfo> = {
  discord: {
    ...
    steps: [
      ...
      "Enter your token below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  telegram: {
  ...
  slack: {
    ...
    steps: [
      ...
      "Enter both tokens below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  signal: {
    ...
    steps: [
      ...
      "Enter the phone number below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  imessage: {
    ...
    steps: [
      ...
      "Enter iMessage config below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  whatsapp: {
    ...
    credentials: [],
    steps: [
      'Click "Enable" below to turn on WhatsApp',
  ...
  matrix: {
    ...
    steps: [
      ...
      "Enter homeserver URL and token below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  "ms-teams": {
  ...
  irc: {
    ...
    steps: [
      ...
      "Enter server, nick, and channel below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  line: {
    ...
    steps: [
      ...
      "Enter both below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  nostr: {
    ...
    steps: [
      ...
      "Enter your nsec private key below, then click Save to Config",
  ...
  "google-chat": {
    ...
    steps: [
      ...
      "Enter the key path below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  mattermost: {
    ...
    steps: [
      ...
      "Enter the server URL and token below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  twitch: {
    ...
    steps: [
      ...
      "Enter the token and channel below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  feishu: {
    ...
    steps: [
      ...
      "Enter app ID and secret below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  zalo: {
  ...
  "synology-chat": {
    ...
    steps: [
      ...
      "Enter the webhook URL below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  "nextcloud-talk": {
    ...
    steps: [
      ...
      "Enter server URL and token below, then click Save to Config",
    ],
    hasSandbox: false,
  },
  lobster: {
  ...
  bluebubbles: {
    ...
    steps: [
      ...
      "Enter server URL and password below, then click Save to Config",
    ],
    hasSandbox: false,
  },
};
