    ...
    <div className="rounded-2xl glass-panel p-4">
      ...
      <div className="flex items-center justify-around mt-3 pt-3 border-t border-[var(--glass-border)]">
        <div className="text-center">
          <span className="text-xs font-mono text-green-400">+{currency(metrics.avgWin)}</span>
          <span className="block text-[9px] text-neutral-600">{t("avgWin")}</span>
        </div>
        <div className="text-center">
          <span className="text-xs font-mono text-red-400">-{currency(metrics.avgLoss)}</span>
        ...
        <div className="text-center">
          ...
          >
            {metrics.totalPnl >= 0 ? "+" : ""}
            {currency(Math.abs(metrics.totalPnl))}
          </span>
