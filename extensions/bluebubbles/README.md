...
This directory contains the **BlueBubbles external channel plugin** for Tigerpaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `tigerpaw/plugin-sdk` helpers.
