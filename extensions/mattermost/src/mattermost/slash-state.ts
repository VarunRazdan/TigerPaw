...
import type { OpenClawPluginApi } from "tigerpaw/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("tigerpaw/plugin-sdk/mattermost").OpenClawConfig;
    runtime: import("tigerpaw/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
