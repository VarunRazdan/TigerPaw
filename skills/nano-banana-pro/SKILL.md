...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.tigerpaw/tigerpaw.json`
...
- The script prints a `MEDIA:` line for Tigerpaw to auto-attach on supported chat providers.
