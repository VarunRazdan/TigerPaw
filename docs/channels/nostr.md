...
read_when:
  - You want Tigerpaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Tigerpaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`tigerpaw onboard`) and `tigerpaw channels add` list optional channel plugins.
...
```bash
tigerpaw plugins install @tigerpaw/nostr
```

Use a local checkout (dev workflows):

```bash
tigerpaw plugins install --link <path-to-tigerpaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "tigerpaw",
        "displayName": "Tigerpaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "tigerpaw@example.com",
        "lud16": "tigerpaw@example.com"
      }
    }
  }
}
