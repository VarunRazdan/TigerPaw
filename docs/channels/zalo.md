...
- Install via CLI: `tigerpaw plugins install @tigerpaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `tigerpaw plugins install ./extensions/zalo`
   - From npm (if published): `tigerpaw plugins install @tigerpaw/zalo`
...
- Approve via:
  - `tigerpaw pairing list zalo`
  - `tigerpaw pairing approve zalo <CODE>`
...
- Example: `tigerpaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `tigerpaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `tigerpaw logs --follow`
