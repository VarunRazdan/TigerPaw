---
summary: "Synology Chat webhook setup and Tigerpaw config"
read_when:
  - Setting up Synology Chat with Tigerpaw
...
```bash
tigerpaw plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Tigerpaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Tigerpaw.
...
- Pairing approvals work with:
  - `tigerpaw pairing list synology-chat`
  - `tigerpaw pairing approve synology-chat <CODE>`
...
```bash
tigerpaw message send --channel synology-chat --target 123456 --text "Hello from Tigerpaw"
tigerpaw message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
