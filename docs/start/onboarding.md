---
summary: "First-run onboarding flow for Tigerpaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Tigerpaw">
...
<Step title="CLI">
  ...
  The app can install the global `tigerpaw` CLI via npm/pnpm so terminal
