---
summary: "Overview of Tigerpaw onboarding options and flows"
read_when:
...
Tigerpaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`tigerpaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the Tigerpaw app when you want a fully guided setup on macOS. Docs:
