...
Deploy Tigerpaw on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/tigerpaw` — Control UI
...
- `OPENCLAW_STATE_DIR=/data/.tigerpaw` (recommended)
...
This exports your Tigerpaw state + workspace so you can migrate to another host without losing config or memory.
