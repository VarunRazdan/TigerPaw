...
Tigerpaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Tigerpaw also aligns
the install method:
...
When you switch channels with `tigerpaw update`, Tigerpaw also syncs plugin sources:
