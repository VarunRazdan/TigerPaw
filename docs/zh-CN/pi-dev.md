...
本指南总结了在 Tigerpaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 Tigerpaw 状态目录下。默认为 `~/.tigerpaw`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://github.com/varunrazdan/tigerpaw/testing
- https://github.com/varunrazdan/tigerpaw/start/getting-started
