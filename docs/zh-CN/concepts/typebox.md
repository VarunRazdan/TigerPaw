...
- 生成的 Swift 模型：`apps/macos/Sources/TigerpawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/varunrazdan/tigerpaw/main/dist/protocol.schema.json
