...
summary: Machine-checked security models for Tigerpaw’s highest-risk paths.
read_when:
...
This page tracks Tigerpaw’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Tigerpaw enforces its
...
**What this is not (yet):** a proof that “Tigerpaw is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/tigerpaw-formal-models](https://github.com/vignesh07/tigerpaw-formal-models).
...
```bash
git clone https://github.com/vignesh07/tigerpaw-formal-models
cd tigerpaw-formal-models
