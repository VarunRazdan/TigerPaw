...
read_when:
  - You are building a Tigerpaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (tigerpaw.plugin.json)

Every plugin **must** ship a `tigerpaw.plugin.json` file in the **plugin root**.
Tigerpaw uses this manifest to validate configuration **without executing plugin
