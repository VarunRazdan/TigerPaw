...
read_when:
  - You want to publish a third-party Tigerpaw plugin
...
This page tracks high-quality **community-maintained plugins** for Tigerpaw.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `tigerpaw plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `tigerpaw plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect Tigerpaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/tigerpaw-wechat`
  repo: `https://github.com/icesword0760/tigerpaw-wechat`
  install: `tigerpaw plugins install @icesword760/tigerpaw-wechat`
