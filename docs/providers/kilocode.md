---
summary: "Use Kilo Gateway's unified API to access many models in Tigerpaw"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Tigerpaw
---
...
```bash
tigerpaw onboard --kilocode-api-key <key>
```
...
Tigerpaw dynamically discovers available models from the Kilo Gateway at startup. Use
