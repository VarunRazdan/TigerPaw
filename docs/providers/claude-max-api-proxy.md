...
You can point Tigerpaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Tigerpaw
...
- [Anthropic provider](/providers/anthropic) - Native Tigerpaw integration with Claude setup-token or API keys
