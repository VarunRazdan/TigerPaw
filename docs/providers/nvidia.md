---
summary: "Use NVIDIA's OpenAI-compatible API in Tigerpaw"
read_when:
  - You want to use NVIDIA models in Tigerpaw
...
tigerpaw onboard --auth-choice skip
tigerpaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
