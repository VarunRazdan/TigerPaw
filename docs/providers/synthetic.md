---
summary: "Use Synthetic's Anthropic-compatible API in Tigerpaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Tigerpaw registers it as the
...
Note: Tigerpaw's Anthropic client appends `/v1` to the base URL, so use
