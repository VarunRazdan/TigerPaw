---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Tigerpaw"
read_when:
  - You want Xiaomi MiMo models in Tigerpaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Tigerpaw uses
