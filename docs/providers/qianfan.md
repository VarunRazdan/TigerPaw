---
summary: "Use Qianfan's unified API to access many models in Tigerpaw"
read_when:
...
3. Tigerpaw installed on your system
...
4. Copy the API key for use with Tigerpaw

## CLI setup

```bash
tigerpaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Tigerpaw Configuration](/gateway/configuration)
