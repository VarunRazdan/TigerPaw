---
summary: "Use Qwen OAuth (free tier) in Tigerpaw"
read_when:
  - You want to use Qwen with Tigerpaw
...
If you already logged in with the Qwen Code CLI, Tigerpaw will sync credentials
