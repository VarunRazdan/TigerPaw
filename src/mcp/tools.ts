...
export async function executeTool(
  ...
  switch (name) {
    ...
    case "place_order": {
      ...
      const _orderType = typeof args.orderType === "string" ? args.orderType : "market";
    ...
    case "toggle_kill_switch": {
      ...
      const reason = typeof args.reason === "string" ? args.reason : "Toggled via MCP";
      const mode = (typeof args.mode === "string" ? args.mode : "hard") as "hard" | "soft";
    ...
    case "run_backtest": {
      const strategyId = typeof args.strategyId === "string" ? args.strategyId : "";
      if (!strategyId) {
      ...
      const symbol =
        typeof args.symbol === "string" ? args.symbol : (strategy.symbols[0] ?? "DEMO");
