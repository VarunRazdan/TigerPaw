...
export type PositionSizingMethod = "fixed_usd" | "percent_portfolio" | "kelly" | "risk_parity";
...
export type StrategyDefinition = {
  ...
  // Ownership (optional for backward compatibility with existing data)
  ownerId?: string;
  ownerLabel?: string;
  // Target
  symbols: string[];
...
export type StrategyExecutionStatus = "running" | "completed" | "error" | "stopped";
