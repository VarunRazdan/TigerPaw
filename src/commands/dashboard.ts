...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set TIGERPAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `tigerpaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Tigerpaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
