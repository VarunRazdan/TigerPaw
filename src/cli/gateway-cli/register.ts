      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["tigerpaw gateway run", "Run the gateway in the foreground."],
            ["tigerpaw gateway status", "Show service status and probe reachability."],
            ["tigerpaw gateway discover", "Find local and wide-area gateway beacons."],
            ["tigerpaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.tigerpaw.dev/cli/gateway")}\n`,
      ),
  );
