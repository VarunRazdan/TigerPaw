    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["tigerpaw directory self --channel slack", "Show the connected account identity."],
          [
            'tigerpaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["tigerpaw directory groups list --channel discord", "List available groups/channels."],
          [
            "tigerpaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.tigerpaw.dev/cli/directory",
        )}\n`,
    )
    .action(() => {
