...
const EXAMPLES = [
  ["tigerpaw models --help", "Show detailed help for the models command."],
  [
    "tigerpaw channels login --verbose",
    "Link personal WhatsApp Web and show QR + connection logs.",
  ],
  [
    'tigerpaw message send --target +15555550123 --message "Hi" --json',
    "Send via your web session and print JSON result.",
  ],
  ["tigerpaw gateway --port 18789", "Run the WebSocket Gateway locally."],
  ["tigerpaw --dev gateway", "Run a dev Gateway (isolated state/config) on ws://127.0.0.1:19001."],
  ["tigerpaw gateway --force", "Kill anything bound to the default gateway port, then start it."],
  ["tigerpaw gateway ...", "Gateway control via WebSocket."],
  [
    'tigerpaw agent --to +15555550123 --message "Run summary" --deliver',
    "Talk directly to the agent using the Gateway; optionally send the WhatsApp reply.",
  ],
  [
    'tigerpaw message send --channel telegram --target @mychat --message "Hi"',
